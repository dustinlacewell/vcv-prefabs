...
MenuItem* ModuleSorter::createSortTypeMenu() {
    ...
    item->childMenuCallback = [this](ModularMenuItem* item, Menu* menu) {
        ...
        alphaItem->rightTextCallback = [this]() {
            return CHECKMARK(sortType == ALPHA);
        };
        ...
        usageItem->rightTextCallback = [this]() {
            return CHECKMARK(sortType == USAGE);
        };
        ...
        favoriteThenAlphaItem->rightTextCallback = [this]() {
            return CHECKMARK(sortType == FAVORITE_THEN_ALPHA);
        };
        ...
        favoriteThenUsageItem->rightTextCallback = [this]() {
            return CHECKMARK(sortType == FAVORITE_THEN_USAGE);
        };
